...
define('WEBKIT', SISTEMA.'webkit/');
define('LANG', SISTEMA.'idiomas/');
define('CLASS_DIR', SISTEMA.'clase/');

include(LANG."lang.php");
include(CLASS_DIR."autocarga.php");
include(SISTEMA."function.php");
include(SISTEMA."OOP.php");
