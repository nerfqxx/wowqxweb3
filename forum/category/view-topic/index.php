...
?>
<head>
    <title>Foro - WoW Qx Server</title>
...
<<<<<<< HEAD
                            ...
                            $forum = $db->Web("SELECT * FROM forum_forums WHERE id = '" . $thread['forumid'] . "'") or $error = 1;
                ...
                <div class="content-bot">
                    <div id="forum-content">
                        ...
                        <script type="text/javascript">
                            //<![CDATA[
                            $(function() {
                                Cms.Forum.threadListInit('<?php echo $thread['id']; ?>');
                            });
                            //]]>
                        </script>
					...
					<a class="ui-button button1 imgbutton " href="../?f=' . $thread['forumid'] . '"><span><span><span class="back-arrow"> </span></span></span></a>';
                                if (isset($_SESSION['username'])) {
                                    if ($thread['locked'] == 0 && $userInfo['class'] == "") {
                                        ...
                                        echo '<a class="ui-button button1" href="#new-post"><span><span>' . $Forum['Forum61'] . '</span></span></a>';
                                        if ($thread['locked'] == 0)
                                            echo '<a class="ui-button button1" href="../edit-post/lock.php?p=' . $postid['id'] . '"><span><span>Close Topic</span></span></a>';
                                        else
                                            echo '<a class="ui-button button1" href="../edit-post/lock.php?p=' . $postid['id'] . '"><span><span>Open Topic</span></span></a>';
					...
					<tr>
						...
						<div class="post-user">
							...
							<div class="character-info">
                                ...
                                switch ($posterInfo['class']) {
                                    case "blizz": echo '<div class="blizzard-title">' . $Forum['Forum63'] . '</div>';
                                        break;
                                    case "mvp": echo '<div class="mvp-title">' . $Forum['Forum64'] . '</div>';
                                        break;
                                    default:
                                        echo'<div>';
                                        if ($char['val'] == 1) {
