                ...
                <div class="content-trail">
                    <ol class="ui-breadcrumb">
                        ...
                        if ($_GET['f'] != "") {
						  ...
						  //$get_allthreads = mysql_query("SELECT * FROM aquaflame2.forum_threads WHERE forumid = '" . $forum['id'] . "'");
						  //$row_query = $db->Web("SELECT * FROM news WHERE id <= '{$row_first}' ORDER BY `id` DESC LIMIT 8");
                            $get_allthreads = $db->Web("SELECT * FROM aquaflame2.forum_threads WHERE forumid = '" . $forum['id'] . "'");
                            echo '
	<li>
